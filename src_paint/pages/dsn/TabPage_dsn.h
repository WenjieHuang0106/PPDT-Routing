#pragma once
#include <QWidget>
#include "../../../src_services/RoutingController.h"
#include "../../TabPageBase.h"
#include "../../../src_config/AppConfig.h"
#include "../../DiagramStyle.h"
#include "../../../src_data/dsn/DataParser_dsn.h"

class TabPage_dsn : public TabPageBase
{
    Q_OBJECT
public:
    TabPage_dsn(QString qFullName, QString qFilePath, QString qFileName, QWidget* parent)
        : TabPageBase(qFullName, qFilePath, qFileName, parent) {
		m_data = new Data_dsn();
...
private:
    ...
    RoutingController* m_algm = nullptr;

private:
    AppConfig* m_config = nullptr;	//配置信息
    void fillData(AppConfig* conf);
    void refreshUI();
public:
